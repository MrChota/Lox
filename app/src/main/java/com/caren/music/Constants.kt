...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=com.caren.music"
    const val TRANSLATE = "https://crowdin.com/project/retromusicplayer"
    const val WEBSITE = "https://www.mrbhai.ml"
    const val GITHUB_PROJECT = "https://github.com/MrChota/Lox"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/bhaeinc"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_INSTAGRAM_LINK = "https://www.instagram.com/mrbhai/"
    const val APP_TELEGRAM_LINK = "https://t.me/bhaeinc/"
    const val APP_TWITTER_LINK = "https://twitter.com/MrBhaee"
    const val FAQ_LINK = "https://github.com/MrChota/Lox/blob/master/FAQ.md"
    const val PINTEREST = "https://in.pinterest.com/mrbhai/"
