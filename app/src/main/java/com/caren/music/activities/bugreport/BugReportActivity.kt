 ...
 *
 */
package com.caren.music.activities.bugreport
...
import com.caren.music.activities.base.AbsThemeActivity
import com.caren.music.activities.bugreport.model.DeviceInfo
import com.caren.music.activities.bugreport.model.Report
import com.caren.music.activities.bugreport.model.github.ExtraInfo
import com.caren.music.activities.bugreport.model.github.GithubLogin
import com.caren.music.activities.bugreport.model.github.GithubTarget
import com.caren.music.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    private fun sendBugReport(login: GithubLogin) {
        ...
        val target = GithubTarget("MrChota", "Lox")
    ...
    companion object {
        ...
        private const val ISSUE_TRACKER_LINK = "https://github.com/MrChota/Lox"
    }
}
